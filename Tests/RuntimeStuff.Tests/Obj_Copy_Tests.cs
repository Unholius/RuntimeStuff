...
//        {
//            var src = new Source { EventId = 1, Name = "Test", Extra = "X" };
//            var tgt = new Target();

//            Obj.Copy(src, tgt, false, true, false);

//            Assert.AreEqual(1, tgt.EventId);
...
//        {
//            var src = new Source { EventId = 2, Name = "Bob", Extra = "Y" };
//            var tgt = new Target();
...
//        {
//            var src = new Source { EventId = 3, Name = "Deep", Extra = "Z" };
//            var tgt = new Target();

//            Obj.Copy(src, tgt, true, true, false);

//            Assert.AreEqual(3, tgt.EventId);
...
//        {
//            var src = new Source { EventId = 4, Name = "A", Extra = "B", NullProp = "fromSrc" };
//            var tgt = new Target { EventId = 0, Name = null, NullProp = null };

//            Obj.Copy(src, tgt, false, true, true);

//            Assert.AreEqual(4, tgt.EventId);
...
//        {
//            var src = new Source { EventId = 5, Name = null, Extra = "C", NullProp = null };
//            var tgt = new Target { EventId = 10, Name = "old", NullProp = "old" };
