    ...
    public class BindingCollection<T> : BindingList<T>, IBindingListView, INotifyCollectionChanged, INotifyPropertyChanged
    {
        ...
        public string Filter
        {
            ...
            set
            {
                ...
                this.filter = value;
                this.filterFunc = CreateFilterPredicate(value);
        ...
        public void ApplySort(ListSortDescriptionCollection sorts)
        {
            ...
            this.isSorted = this.sortProperties.Count > 0;
            this.RebuildView();
        }
        ...
        protected override void SetItem(int index, T item)
        {
            ...
            var srcIndex = this.source.IndexOf(oldItem);
        ...
        private static Func<T, int, bool> CreateFilterPredicate(string filter)
        {
        ...
        private IEnumerable<T> ApplyOrdering(IEnumerable<T> query)
        {
            ...
            for (var i = 0; i < this.sortProperties.Count; i++)
            {
                var prop = this.sortProperties[i];
                var dir = this.sortDirections[i];

                object Key(T x) => prop.GetValue(x);
