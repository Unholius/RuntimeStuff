...
//        public static bool IsTuple(this Type type) => TypeHelper.IsTuple(type);
...
//        public static bool IsNumeric(this Type type) => TypeHelper.IsNumeric(type);
...
//        public static bool IsDictionary(this Type type) => TypeHelper.IsDictionary(type);
...
//        public static bool IsFloat(this Type type) => TypeHelper.IsFloat(type);
...
//        public static bool IsBasic(this Type type) => TypeHelper.IsBasic(type);
...
//        public static bool IsBoolean(this Type type) => TypeHelper.IsBoolean(type);
...
//        public static bool IsCollection(this Type type) => TypeHelper.IsCollection(type);
...
//        public static bool IsDate(this Type type) => TypeHelper.IsDate(type);
...
//        public static bool IsDelegate(this Type type) => TypeHelper.IsDelegate(type);
...
//        public static bool IsImplements(this Type type, Type interfaceType) => TypeHelper.IsImplements(type, interfaceType);
...
//        public static bool IsImplements<TInterface>(this Type type) => TypeHelper.IsImplements<TInterface>(type);
...
//        public static Type[] GetBaseTypes(this Type type, bool includeThis = false, bool getInterfaces = false) => TypeHelper.GetBaseTypes(type, includeThis, getInterfaces);
...
//        /// <param name="type">The type.</param>
//        /// <returns>Type.</returns>
//        public static Type GetCollectionItemType(this Type type) => TypeHelper.GetCollectionItemType(type);
...
//        public static IEnumerable<PropertyInfo> GetPublicProperties(this Type type) => TypeHelper.GetPublicProperties(type);
...
//        /// <returns>PropertyInfo.</returns>
//        public static PropertyInfo GetPublicProperty(this Type type, string propertyName) => TypeHelper.GetPublicProperty(type, propertyName);
...
//        public static IEnumerable<string> GetPublicPropertyNames(this Type type) => TypeHelper.GetPublicPropertyNames(type);
...
//        /// <returns>Type[].</returns>
//        public static Type[] GetImplementationsOf(this Type baseType, Assembly fromAssembly) => TypeHelper.GetImplementationsOf(baseType, fromAssembly);
...
//        /// <param name="baseType">Type of the base.</param>
//        /// <returns>Type[].</returns>
//        public static Type[] GetImplementationsOf(this Type baseType) => TypeHelper.GetImplementationsOf(baseType);
