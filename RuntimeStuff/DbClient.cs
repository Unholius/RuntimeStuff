namespace RuntimeStuff
{
    ...
    public class DbClient : IDisposable, IHaveOptions<SqlProviderOptions>
    {
        ...
        public static DbValueConverter TrimStringSpaces = (name, value, info, item) =>
            value is string s ? s.Trim(TrimChars) : ChangeType(value, info.PropertyType);
        ...
        public int Update<T>(
            T item,
            IDbTransaction dbTransaction = null,
            params Expression<Func<T, object>>[] updateColumns) where T : class => this.Update(item, null, dbTransaction, updateColumns);
        ...
        public Task<int> UpdateAsync<T>(
            ...
            IDbTransaction dbTransaction = null,
            CancellationToken token = default) where T : class => this.UpdateAsync(
                item,
                null,
        ...
        /// <param name="whereExpression">
        ///     Условие для фильтрации записей для обновления. Может быть null, если условие не
        ///     требуется.
        /// </param>
        ...
        /// <param name="dbTransaction">
        ///     Транзакция, в рамках которой будет выполнено обновление. Если null, создается новая
        ///     транзакция.
        /// </param>
        /// <param name="updateColumns">Массив столбцов для обновления. Если null, обновляются все столбцы объекта.</param>
        ...
        ///     Фабрика для создания объекта типа <typeparamref name="T" /> из данных строки. Может быть
        ///     <c>null</c>.
        /// </param>
        /// <returns>Первый элемент результата выборки или <c>null</c>, если результат пуст.</returns>
        /// <remarks>
        ///     Этот метод выполняет запрос синхронно и возвращает первый элемент результата или <c>null</c>, если данные
        ///     отсутствуют.
        /// </remarks>
        public T First<T>(
            string query = null,
        ...
        /// <remarks>
        ///     Этот метод выполняет запрос синхронно с учётом условия выборки и сортировки, и возвращает первый элемент результата
        ///     или <c>null</c>, если данные отсутствуют.
        /// </remarks>
        public T First<T>(
            Expression<Func<T, bool>> whereExpression,
            IEnumerable<(string, string)> columnToPropertyMap = null,
        ...
        /// <remarks>
        ///     Этот метод выполняет запрос асинхронно и возвращает первый элемент результата или <c>null</c>, если данные
        ///     отсутствуют.
        /// </remarks>
        ...
        /// <remarks>
        ///     Этот метод выполняет запрос асинхронно с учётом условия выборки и сортировки, и возвращает первый элемент
        ///     результата или <c>null</c>, если данные отсутствуют.
        /// </remarks>
        public async Task<T> FirstAsync<T>(
            Expression<Func<T, bool>> whereExpression,
            IEnumerable<(string, string)> columnToPropertyMap = null,
        ...
        ///     Тайм-аут выполнения команды в секундах. Если не задано, используется значение по
        ///     умолчанию.
        /// </param>
        ...
        /// <remarks>
        ///     Этот метод извлекает параметры из переданного объекта. Он поддерживает работу с различными типами данных, такими
        ///     как:
        ///     <list type="bullet">
        ///         <item>
        ///             <description>Словари (Dictionary)</description>
        ///         </item>
        ///         <item>
        ///             <description>Коллекции (IEnumerable)</description>
        ///         </item>
        ///         <item>
        ///             <description>Кортежи (Tuple)</description>
        ///         </item>
        ///     </list>
        ...
        public async Task<TList> QueryAsync<TList, T>(
            ...
            int offsetRows = 0,
            Func<object[], string[], T> itemFactory = null,
            CancellationToken ct = default) where TList : ICollection<T>, new()
        {
            if (string.IsNullOrEmpty(query))
            {
                query = SqlQueryBuilder.GetSelectQuery<T>(this.Options);
        ...
        /// <remarks>
        ///     Этот метод выполняет SQL-запрос асинхронно и преобразует результат в словарь
        ...
        /// <remarks>
        ///     Этот метод выполняет SQL-запрос синхронно с фильтрацией по выражению <paramref name="whereExpression" /> и
        ...
        /// <remarks>
        ///     Этот метод выполняет асинхронный подсчет общего числа строк и делит их на страницы в зависимости от заданного
        ///     размера страницы.
        /// </remarks>
        public async Task<int> GetPagesCountAsync<TFrom>(
            int pageSize,
            Expression<Func<TFrom, bool>> whereExpression,
            CancellationToken token = default) where TFrom : class
        {
        ...
        /// <param name="token">Токен отмены асинхронной операции.</param>
        /// <returns>
        ///     Задача, которая возвращает словарь с номером страницы в качестве ключа и кортежем с смещением и количеством
        ///     элементов.
        /// </returns>
        /// <remarks>
        ...
        /// <remarks>
        ///     Этот метод выполняет подсчет количества строк в запросе, оборачивая его в подзапрос с использованием SQL-функции
        ///     COUNT.
        /// </remarks>
        ...
        /// <remarks>
        ///     Этот метод асинхронно выполняет подсчет количества строк в запросе, оборачивая его в подзапрос с использованием
        ///     SQL-функции COUNT.
        /// </remarks>
        ...
        /// <returns>Задача, которая возвращает количество строк в результате запроса.</returns>
        /// <remarks>
        ///     Этот метод выполняет асинхронный подсчет строк в SQL-запросе, оборачивая его в подзапрос с использованием
        ///     SQL-функции COUNT.
        /// </remarks>
        ...
        /// <remarks>
        ///     Этот метод выполняет агрегацию данных с использованием SQL-функции COUNT для конкретной колонки в сущности и
        ///     преобразует результат в тип <typeparamref name="T" />.
        /// </remarks>
        public object Count<TFrom>(
            Expression<Func<TFrom, bool>> whereExpression = null,
            Expression<Func<TFrom, object>> columnSelector = null) where TFrom : class
        {
        ...
        public async Task<object> CountAsync<TFrom>(
            ...
            CancellationToken token = default) where TFrom : class => (await this.AggAsync("count", whereExpression, token, columnSelector)
        ...
        /// <remarks>
        ///     Этот метод выполняет асинхронный подсчет строк для конкретной колонки с использованием SQL-функции COUNT и
        ///     преобразует результат в тип <typeparamref name="T" />.
        /// </remarks>
        ...
        /// <remarks>
        ///     Этот метод использует SQL-функцию MAX для получения максимального значения в столбце, а затем преобразует результат
        ///     в тип <typeparamref name="T" />.
        /// </remarks>
        ...
        public object Max<TFrom>(
            ...
            Expression<Func<TFrom, bool>> whereExpression = null) where TFrom : class => this.Agg("MAX", whereExpression, columnSelector).Values.FirstOrDefault();
        ...
        /// <param name="token">Токен отмены асинхронной операции.</param>
        /// <returns>
        ///     Задача, которая возвращает максимальное значение для указанного столбца, преобразованное в тип
        ///     <typeparamref name="T" />.
        /// </returns>
        /// <remarks>
        ///     Этот метод асинхронно использует SQL-функцию MAX для получения максимального значения и преобразует результат в тип
        ///     <typeparamref name="T" />.
        /// </remarks>
        ...
        public async Task<object> MaxAsync<TFrom>(
            Expression<Func<TFrom, bool>> whereExpression = null,
            Expression<Func<TFrom, object>> columnSelector = null,
            CancellationToken token = default) where TFrom : class => (await this.AggAsync("MAX", whereExpression, token, columnSelector)
                .ConfigureAwait(this.ConfigureAwait)).Values.FirstOrDefault();
        ...
        /// <remarks>
        ///     Этот метод использует SQL-функцию MIN для получения минимального значения в столбце, а затем преобразует результат
        ///     в тип <typeparamref name="T" />.
        /// </remarks>
        ...
        public object Min<TFrom>(
            Expression<Func<TFrom, object>> columnSelector,
            Expression<Func<TFrom, bool>> whereExpression = null) where TFrom : class => this.Agg("MIN", whereExpression, columnSelector).Values.FirstOrDefault();
        ...
        /// <param name="token">Токен отмены асинхронной операции.</param>
        /// <returns>
        ///     Задача, которая возвращает минимальное значение для указанного столбца, преобразованное в тип
        ///     <typeparamref name="T" />.
        /// </returns>
        /// <remarks>
        ///     Этот метод асинхронно использует SQL-функцию MIN для получения минимального значения и преобразует результат в тип
        ///     <typeparamref name="T" />.
        /// </remarks>
        ...
        public async Task<object> MinAsync<TFrom>(
            Expression<Func<TFrom, bool>> whereExpression = null,
            Expression<Func<TFrom, object>> columnSelector = null,
            CancellationToken token = default) where TFrom : class => (await this.AggAsync("MIN", whereExpression, token, columnSelector)
                .ConfigureAwait(this.ConfigureAwait)).Values.FirstOrDefault();
        ...
        /// <remarks>
        ///     Этот метод использует SQL-функцию SUM для получения суммы значений в столбце, а затем преобразует результат в тип
        ///     <typeparamref name="T" />.
        /// </remarks>
        ...
        public object Sum<TFrom>(
            Expression<Func<TFrom, object>> columnSelector,
            Expression<Func<TFrom, bool>> whereExpression = null) where TFrom : class => this.Agg("SUM", whereExpression, columnSelector).Values.FirstOrDefault();
        ...
        /// <remarks>
        ///     Этот метод асинхронно использует SQL-функцию SUM для получения суммы значений в столбце и преобразует результат в
        ///     тип <typeparamref name="T" />.
        /// </remarks>
        ...
        public async Task<object> SumAsync<TFrom>(
            Expression<Func<TFrom, bool>> whereExpression = null,
            Expression<Func<TFrom, object>> columnSelector = null,
            CancellationToken token = default) where TFrom : class => (await this.AggAsync("SUM", whereExpression, token, columnSelector)
                .ConfigureAwait(this.ConfigureAwait)).Values.FirstOrDefault();
        ...
        /// <remarks>
        ///     Этот метод использует SQL-функцию AVG для получения среднего значения в столбце, а затем преобразует результат в
        ///     тип <typeparamref name="T" />.
        /// </remarks>
        ...
        public object Avg<TFrom>(
            Expression<Func<TFrom, object>> columnSelector,
            Expression<Func<TFrom, bool>> whereExpression = null) where TFrom : class => this.Agg("AVG", whereExpression, columnSelector).Values.FirstOrDefault();
        ...
        public async Task<object> AvgAsync<TFrom>(
            Expression<Func<TFrom, bool>> whereExpression = null,
            Expression<Func<TFrom, object>> columnSelector = null,
            CancellationToken token = default) where TFrom : class => (await this.AggAsync("AVG", whereExpression, token, columnSelector)
                .ConfigureAwait(this.ConfigureAwait)).Values.FirstOrDefault();
        ...
        /// <returns>
        ///     Словарь, где ключом является имя столбца, а значением кортеж с результатами агрегаций (Count, Min, Max, Sum,
        ///     Avg).
        /// </returns>
        /// <remarks>
        ///     Этот метод выполняет несколько агрегационных операций (COUNT, MIN, MAX, SUM, AVG) для каждого указанного столбца и
        ...
        public Dictionary<string, (long Count, long Min, long Max, long Sum, decimal Avg)> GetAggs<TFrom>(
            Expression<Func<TFrom, bool>> whereExpression = null,
            params Expression<Func<TFrom, object>>[] columnSelector) where TFrom : class
        {
        ...
        /// <remarks>
        ///     Этот метод асинхронно выполняет несколько агрегационных операций (COUNT, MIN, MAX, SUM, AVG) для каждого указанного
        ///     столбца.
        /// </remarks>
        ...
        /// <remarks>
        ///     Этот метод выполняет одну агрегационную функцию (например, COUNT) для каждого указанного столбца и возвращает
        ///     результат в виде словаря.
        /// </remarks>
        public Dictionary<string, object> Agg<TFrom>(
            string aggFunction,
            Expression<Func<TFrom, bool>> whereExpression,
            params Expression<Func<TFrom, object>>[] columnSelectors) where TFrom : class => this.Agg(
                whereExpression,
        ...
        public Task<Dictionary<string, object>> AggAsync<TFrom>(
            ...
            Expression<Func<TFrom, bool>> whereExpression = null,
            CancellationToken token = default,
            params Expression<Func<TFrom, object>>[] columnSelectors) where TFrom : class => this.AggAsync(
                whereExpression,
                token,
                columnSelectors?.Any() == true ? columnSelectors.Select(c => (c, aggFunction)).ToArray() : new[] { ((Expression<Func<TFrom, object>>)null, aggFunction) });
        ...
        /// <remarks>
        ///     Этот метод позволяет выбрать несколько столбцов и применить различные агрегационные функции (например, COUNT, MIN,
        ///     MAX, SUM, AVG).
        /// </remarks>
        public Dictionary<string, object> Agg<TFrom>(
            Expression<Func<TFrom, bool>> whereExpression = null,
            params (Expression<Func<TFrom, object>> column, string aggFunction)[] columnSelectors) where TFrom : class
        {
        ...
        private async Task<TList> ReadCoreAsync<TList, T>(
            ...
            bool isAsync,
            CancellationToken ct) where TList : ICollection<T>, new()
        {
