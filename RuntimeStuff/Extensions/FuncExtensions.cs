...
// ***********************************************************************
// <copyright file="FuncExtensions.cs" company="Rudnev Sergey">
...
namespace RuntimeStuff.Extensions
{
    ...
    /// сценариях.
    /// </summary>
    /// <remarks>Методы этого класса полезны при работе с делегатами, когда требуется унифицировать сигнатуру для
    ...
    /// совместимы с ожидаемыми типами, чтобы избежать ошибок времени выполнения.</remarks>
    public static class FuncExtensions
    {
        ...
        /// <param name="resultConverter">Функция для преобразования результата типа R в тип object. Если не указана, результат
        /// приводится к типу object.</param>
        /// <returns>Функция, принимающая значение типа object, преобразующая его к типу T1, вызывающая исходную функцию и
        /// возвращающая результат в виде object.</returns>
        /// к типу T1 с помощью приведения.
        /// <remarks>Полученная функция может быть полезна для универсального вызова типизированных функций,
        /// например, при работе с рефлексией или динамическими сценариями. Если преобразователи не указаны, используется
        /// стандартное приведение типов, что может привести к исключениям при несовпадении типов.</remarks>
        ...
        /// <typeparam name="TR">Тип возвращаемого значения исходной функции.</typeparam>
        /// <param name="func">Исходная функция, которую требуется преобразовать. Не может быть равна null.</param>
        /// <param name="converter1">Функция для преобразования входного значения типа object в тип T1. Если не указана, входное значение приводится
        /// к типу T1 с помощью приведения.</param>
        /// <param name="resultConverter">Функция для преобразования результата типа R в тип object. Если не указана, результат
        /// приводится к типу object.</param>
        /// <returns>Функция, принимающая значение типа object, преобразующая его к типу T1, вызывающая исходную функцию и
        /// возвращающая результат в виде object.</returns>
        ...
        /// <param name="converter1">Функция для преобразования входного значения типа object в тип T1. Если не указана, входное значение приводится
        /// к типу T1 с помощью приведения.</param>
        /// <param name="resultConverter">Функция для преобразования результата типа R1 в тип R2. Если не указана, результат
        /// приводится к типу object.</param>
        /// <returns>Функция, принимающая значение типа object, преобразующая его к типу T1, вызывающая исходную функцию и
        /// возвращающая результат в виде object.</returns>
        /// <remarks>Полученная функция может быть полезна для универсального вызова типизированных функций,
        ...
        /// </summary>
        /// <typeparam name="T1">The type of the t1.</typeparam>
        /// <typeparam name="TR1">The type of the t r1.</typeparam>
        /// <param name="func">The function.</param>
        /// <returns>Func&lt;System.Object, TR1&gt;.</returns>
        ...
        /// <typeparam name="TR">Тип возвращаемого значения исходной функции.</typeparam>
        /// <param name="func">Исходная функция, которую требуется преобразовать. Не может быть равна null.</param>
        /// <param name="converter1">Функция для преобразования входного значения типа object в тип T1. Если не указана, входное
        /// значение приводится к типу T1 с помощью приведения.</param>
        /// <param name="converter2">Функция для преобразования входного значения типа object в тип T2. Если не указана, входное
        /// значение приводится к типу T1 с помощью приведения.</param>
        /// <param name="resultConverter">Функция для преобразования результата типа R в тип object. Если не указана, результат
        /// приводится к типу object.</param>
        ...
        /// <typeparam name="TR1">The type of the t r1.</typeparam>
        /// <typeparam name="TR2">The type of the t r2.</typeparam>
        /// <param name="func">The function.</param>
        ...
        /// <returns>Func&lt;System.Object, System.Object, TR2&gt;.</returns>
        ...
        /// <param name="converter1">The converter1.</param>
        /// <param name="converter2">The converter2.</param>
        /// <returns>Func&lt;System.Object, System.Object, TR1&gt;.</returns>
        ...
        /// значение приводится к типу T1 с помощью приведения.</param>
        /// <param name="converter2">Функция для преобразования входного значения типа object в тип T2. Если не указана, входное
        /// значение приводится к типу T2 с помощью приведения.</param>
        /// <param name="converter3">Функция для преобразования входного значения типа object в тип T3. Если не указана, входное
        /// значение приводится к типу T3 с помощью приведения.</param>
        /// <param name="resultConverter">Функция для преобразования результата типа R в тип object. Если не указана, результат
        /// приводится к типу object.</param>
        /// <returns>Func&lt;System.Object, System.Object, System.Object, System.Object&gt;.</returns>
        /// <remarks>Полученная функция может быть полезна для универсального вызова типизированных функций,
        /// например, при работе с рефлексией или динамическими сценариями. Если преобразователи не указаны, используется
        /// стандартное приведение типов, что может привести к исключениям при несовпадении типов.</remarks>
        ...
        /// <typeparam name="T2">Тип второго входного параметра исходной функции.</typeparam>
        /// <typeparam name="T3">Тип третьего входного параметра исходной функции.</typeparam>
        /// <typeparam name="T4">Тип четвертого входного параметра исходной функции.</typeparam>
        /// <typeparam name="TR">Тип возвращаемого значения исходной функции.</typeparam>
        /// <param name="func">Исходная функция, которую требуется преобразовать. Не может быть равна null.</param>
        /// <param name="converter1">Функция для преобразования входного значения типа object в тип T1. Если не указана, входное
        /// значение приводится к типу T1 с помощью приведения.</param>
        ...
        /// <param name="converter3">Функция для преобразования входного значения типа object в тип T3. Если не указана, входное
        /// значение приводится к типу T3 с помощью приведения.</param>
        /// <param name="converter4">Функция для преобразования входного значения типа object в тип T4. Если не указана, входное
        /// значение приводится к типу T4 с помощью приведения.</param>
        /// <param name="resultConverter">Функция для преобразования результата типа R в тип object. Если не указана, результат
        /// приводится к типу object.</param>
        /// <returns>Func&lt;System.Object, System.Object, System.Object, System.Object, System.Object&gt;.</returns>
        /// <remarks>Полученная функция может быть полезна для универсального вызова типизированных функций,
        /// например, при работе с рефлексией или динамическими сценариями. Если преобразователи не указаны, используется
        /// стандартное приведение типов, что может привести к исключениям при несовпадении типов.</remarks>
        ...
        /// <typeparam name="T3">Тип третьего входного параметра исходной функции.</typeparam>
        /// <typeparam name="T4">Тип четвертого входного параметра исходной функции.</typeparam>
        /// <typeparam name="T5">Тип пятого входного параметра исходной функции.</typeparam>
        /// <typeparam name="TR">Тип возвращаемого значения исходной функции.</typeparam>
        /// <param name="func">Исходная функция, которую требуется преобразовать. Не может быть равна null.</param>
        /// <param name="converter1">Функция для преобразования входного значения типа object в тип T1. Если не указана, входное
        /// значение приводится к типу T1 с помощью приведения.</param>
        ...
        /// <param name="converter4">Функция для преобразования входного значения типа object в тип T4. Если не указана, входное
        /// значение приводится к типу T4 с помощью приведения.</param>
        /// <param name="converter5">Функция для преобразования входного значения типа object в тип T5. Если не указана, входное
        /// значение приводится к типу T5 с помощью приведения.</param>
        /// <param name="resultConverter">Функция для преобразования результата типа R в тип object. Если не указана, результат
        /// приводится к типу object.</param>
        /// <returns>Func&lt;System.Object, System.Object, System.Object, System.Object, System.Object, System.Object&gt;.</returns>
        /// <remarks>Полученная функция может быть полезна для универсального вызова типизированных функций,
        /// например, при работе с рефлексией или динамическими сценариями. Если преобразователи не указаны, используется
        /// стандартное приведение типов, что может привести к исключениям при несовпадении типов.</remarks>
        ...
        /// <typeparam name="TR">Тип возвращаемого значения исходной функции.</typeparam>
        /// <param name="func">Исходная функция, принимающая шесть аргументов указанных типов и возвращающая результат типа R. Не может быть
        /// null.</param>
        /// <param name="converter1">Функция для преобразования первого аргумента из object в тип T1. Если не указана, выполняется
        /// приведение типа.</param>
        /// <param name="converter2">Функция для преобразования второго аргумента из object в тип T2. Если не указана, выполняется
        /// приведение типа.</param>
        /// <param name="converter3">Функция для преобразования третьего аргумента из object в тип T3. Если не указана, выполняется
        /// приведение типа.</param>
        /// <param name="converter4">Функция для преобразования четвертого аргумента из object в тип T4. Если не указана, выполняется приведение
        /// типа.</param>
        /// <param name="converter5">Функция для преобразования пятого аргумента из object в тип T5. Если не указана, выполняется
        /// приведение типа.</param>
        /// <param name="converter6">Функция для преобразования шестого аргумента из object в тип T6. Если не указана, выполняется
        /// приведение типа.</param>
        /// <param name="resultConverter">Функция для преобразования результата типа R в object. Если не указана, результат
        /// возвращается как object.</param>
        /// <returns>Функция, принимающая шесть аргументов типа object, преобразующая их к соответствующим типам и возвращающая
        /// результат в виде object.</returns>
        /// <remarks>Если преобразователь для аргумента не указан, используется стандартное приведение типа. При
        ...
        /// <param name="converter1">Необязательный конвертер для преобразования первого аргумента из object в тип T1. Если не указан, используется
        /// приведение типа.</param>
        /// <param name="converter2">Необязательный конвертер для преобразования второго аргумента из object в тип T2. Если не указан, используется
        /// приведение типа.</param>
        /// <param name="converter3">Необязательный конвертер для преобразования третьего аргумента из object в тип T3. Если не указан, используется
        /// приведение типа.</param>
        /// <param name="converter4">Необязательный конвертер для преобразования четвертого аргумента из object в тип T4. Если не указан,
        /// используется приведение типа.</param>
        /// <param name="converter5">Необязательный конвертер для преобразования пятого аргумента из object в тип T5. Если не указан, используется
        /// приведение типа.</param>
        /// <param name="converter6">Необязательный конвертер для преобразования шестого аргумента из object в тип T6. Если не указан, используется
        /// приведение типа.</param>
        /// <param name="converter7">Необязательный конвертер для преобразования седьмого аргумента из object в тип T7. Если не указан, используется
        /// приведение типа.</param>
        /// <param name="resultConverter">Необязательный конвертер для преобразования результата из типа R в object. Если не указан, результат приводится
        /// к object.</param>
        /// <returns>Функция, принимающая семь аргументов типа object и возвращающая результат типа object, с применением указанных
        /// конвертеров.</returns>
        /// <remarks>Если конвертеры не указаны, для преобразования аргументов и результата используется
        /// стандартное приведение типов. Метод полезен для интеграции типизированных функций с универсальными интерфейсами,
        /// где аргументы и результат представлены как object.</remarks>
        ...
        /// <param name="converter1">Необязательный конвертер для преобразования первого аргумента из object в тип T1. Если не указан, выполняется
        /// приведение типа.</param>
        /// <param name="converter2">Необязательный конвертер для преобразования второго аргумента из object в тип T2. Если не указан, выполняется
        /// приведение типа.</param>
        /// <param name="converter3">Необязательный конвертер для преобразования третьего аргумента из object в тип T3. Если не указан, выполняется
        /// приведение типа.</param>
        /// <param name="converter4">Необязательный конвертер для преобразования четвертого аргумента из object в тип T4. Если не указан, выполняется
        /// приведение типа.</param>
        /// <param name="converter5">Необязательный конвертер для преобразования пятого аргумента из object в тип T5. Если не указан, выполняется
        /// приведение типа.</param>
        /// <param name="converter6">Необязательный конвертер для преобразования шестого аргумента из object в тип T6. Если не указан, выполняется
        /// приведение типа.</param>
        /// <param name="converter7">Необязательный конвертер для преобразования седьмого аргумента из object в тип T7. Если не указан, выполняется
        /// приведение типа.</param>
        /// <param name="converter8">Необязательный конвертер для преобразования восьмого аргумента из object в тип T8. Если не указан, выполняется
        /// приведение типа.</param>
        /// <param name="resultConverter">Необязательная функция для преобразования результата типа R в object. Если не указана, результат приводится к
        /// object.</param>
        /// <returns>Функция, принимающая восемь аргументов типа object и возвращающая результат типа object, с применением указанных
        /// конвертеров.</returns>
        /// <remarks>Если конвертеры не указаны, для преобразования аргументов и результата используется
        /// стандартное приведение типов. Метод полезен для интеграции типизированных функций с динамическими или
        /// универсальными интерфейсами, где аргументы и результат представлены как object.</remarks>
        ...
        /// <param name="func">Исходная функция без параметров, возвращающая значение типа <typeparamref name="TR1" />. Не может
        /// быть равна null.</param>
        /// <param name="resultConverter">Функция преобразования результата, принимающая значение типа <typeparamref name="TR1" /> и возвращающая значение
        ...
        /// <param name="converter1">Функция для преобразования первого входного параметра из типа U1 в тип T1. Если не указана, используется
        /// стандартное преобразование типов.</param>
        /// <param name="converter2">Функция для преобразования второго входного параметра из типа U2 в тип T2. Если не указана, используется
        /// стандартное преобразование типов.</param>
        /// <param name="r2">Функция для преобразования возвращаемого значения из типа R1 в тип R2. Если не указана, используется стандартное
        /// преобразование типов.</param>
        /// <returns>Функция, принимающая параметры типов U1 и U2 и возвращающая значение типа R2, с применёнными преобразованиями
        /// входных и выходного параметров.</returns>
        /// <remarks>Если преобразователи не указаны, для преобразования типов используется стандартный механизм,
        /// реализованный в TypeHelper.ChangeType. Это позволяет использовать функцию с аргументами и возвращаемым значением
        /// других типов без явного указания преобразователей.</remarks>
        ...
        /// <param name="converter1">Функция преобразования первого входного параметра из типа U1 в тип T1. Если не указана, используется стандартное
        /// преобразование типов.</param>
        /// <param name="converter2">Функция преобразования второго входного параметра из типа U2 в тип T2. Если не указана, используется стандартное
        /// преобразование типов.</param>
        /// <param name="converter3">Функция преобразования третьего входного параметра из типа U3 в тип T3. Если не указана, используется
        /// стандартное преобразование типов.</param>
        /// <param name="r2">Функция преобразования возвращаемого значения из типа R1 в тип R2. Если не указана, используется стандартное
        /// преобразование типов.</param>
        /// <returns>Функция, принимающая три параметра типа U1, TU2, TU3 и возвращающая значение типа R2, с применением указанных
        /// преобразователей.</returns>
        /// <remarks>Если преобразователи не заданы, для преобразования типов используется стандартный механизм.
        /// Метод полезен для адаптации функций к различным типам входных и выходных данных.</remarks>
        ...
        /// <param name="converter1">Функция преобразования первого аргумента. Если не указана, используется приведение типа по
        /// умолчанию.</param>
        /// <param name="converter2">Функция преобразования второго аргумента. Если не указана, используется приведение типа по
        /// умолчанию.</param>
        /// <param name="converter3">Функция преобразования третьего аргумента. Если не указана, используется приведение типа по
        /// умолчанию.</param>
        /// <param name="converter4">Функция преобразования четвертого аргумента. Если не указана, используется приведение типа по
        /// умолчанию.</param>
        /// <param name="r2">Функция преобразования возвращаемого значения. Если не указана, используется приведение типа по
        /// умолчанию.</param>
        ...
        /// <remarks>Если преобразующие функции не заданы, для преобразования типов используется стандартное
        /// приведение через TypeHelper.ChangeType. Это может быть полезно для адаптации функций к различным типам данных
        /// без необходимости ручного преобразования.</remarks>
        ...
        /// <typeparam name="TR2">Тип возвращаемого значения преобразованной функции.</typeparam>
        /// <param name="func">Исходная функция, которую требуется преобразовать.</param>
        /// <param name="converter1">Функция преобразования первого параметра. Если не указана, используется приведение типа по
        /// умолчанию.</param>
        /// <param name="converter2">Функция преобразования второго параметра. Если не указана, используется приведение типа по
        /// умолчанию.</param>
        /// <param name="converter3">Функция преобразования третьего параметра. Если не указана, используется приведение типа по
        /// умолчанию.</param>
        /// <param name="converter4">Функция преобразования четвертого параметра. Если не указана, используется приведение типа по
        /// умолчанию.</param>
        /// <param name="converter5">Функция преобразования пятого параметра. Если не указана, используется приведение типа по
        /// умолчанию.</param>
        /// <param name="r2">Функция преобразования возвращаемого значения. Если не указана, используется приведение типа по
        /// умолчанию.</param>
        /// <returns>Функция, принимающая пять параметров преобразованных типов и возвращающая преобразованное значение.</returns>
        /// <remarks>Если преобразователь для параметра или результата не указан, будет выполнено стандартное
        ...
        /// <param name="converter1">Функция преобразования первого аргумента из типа U1 в тип T1. Если не указана, используется стандартное
        /// преобразование типов.</param>
        /// <param name="converter2">Функция преобразования второго аргумента из типа U2 в тип T2. Если не указана, используется стандартное
        /// преобразование типов.</param>
        /// <param name="converter3">Функция преобразования третьего аргумента из типа U3 в тип T3. Если не указана, используется стандартное
        /// преобразование типов.</param>
        /// <param name="converter4">Функция преобразования четвертого аргумента из типа U4 в тип T4. Если не указана, используется стандартное
        /// преобразование типов.</param>
        /// <param name="converter5">Функция преобразования пятого аргумента из типа U5 в тип T5. Если не указана, используется стандартное
        /// преобразование типов.</param>
        /// <param name="converter6">Функция преобразования шестого аргумента из типа U6 в тип T6. Если не указана, используется стандартное
        /// преобразование типов.</param>
        /// <param name="r2">Функция преобразования возвращаемого значения из типа R1 в тип R2. Если не указана, используется стандартное
        /// преобразование типов.</param>
        /// <returns>Функция, принимающая шесть аргументов новых типов и возвращающая результат преобразованного типа.</returns>
        /// <remarks>Если преобразующие функции не заданы, для преобразования типов используется стандартный
        /// механизм преобразования. Это позволяет гибко адаптировать сигнатуру исходной функции к требуемым типам без
        /// изменения её логики.</remarks>
        ...
        /// <param name="converter1">Функция преобразования первого аргумента из типа U1 в T1. Если не указана, используется стандартное
        /// преобразование типов.</param>
        /// <param name="converter2">Функция преобразования второго аргумента из типа U2 в T2. Если не указана, используется стандартное
        /// преобразование типов.</param>
        /// <param name="converter3">Функция преобразования третьего аргумента из типа U3 в T3. Если не указана, используется стандартное
        /// преобразование типов.</param>
        /// <param name="converter4">Функция преобразования четвертого аргумента из типа U4 в T4. Если не указана, используется стандартное
        /// преобразование типов.</param>
        /// <param name="converter5">Функция преобразования пятого аргумента из типа U5 в T5. Если не указана, используется стандартное
        /// преобразование типов.</param>
        /// <param name="converter6">Функция преобразования шестого аргумента из типа U6 в T6. Если не указана, используется стандартное
        /// преобразование типов.</param>
        /// <param name="converter7">Функция преобразования седьмого аргумента из типа U7 в T7. Если не указана, используется стандартное
        /// преобразование типов.</param>
        /// <param name="r2">Функция преобразования возвращаемого значения из типа R1 в R2. Если не указана, используется стандартное
        /// преобразование типов.</param>
        /// <returns>Функция, принимающая аргументы типов U1–U7 и возвращающая значение типа R2, с применёнными преобразованиями к
        /// каждому аргументу и результату.</returns>
        /// <remarks>Если преобразователь для аргумента или результата не указан, используется стандартное
        /// преобразование типов через TypeHelper.ChangeType. Это позволяет гибко адаптировать сигнатуру исходной функции к
        /// требуемым типам без ручного преобразования.</remarks>
        ...
        /// <param name="converter3">Функция преобразования третьего входного параметра из типа U3 в тип T3. Если не указана, используется
        /// стандартное преобразование типов.</param>
        /// <param name="converter4">Функция преобразования четвертого входного параметра из типа U4 в тип T4. Если не указана, используется
        /// стандартное преобразование типов.</param>
        /// <param name="converter5">Функция преобразования пятого входного параметра из типа U5 в тип T5. Если не указана, используется стандартное
        /// преобразование типов.</param>
        /// <param name="converter6">Функция преобразования шестого входного параметра из типа U6 в тип T6. Если не указана, используется стандартное
        /// преобразование типов.</param>
        /// <param name="converter7">Функция преобразования седьмого входного параметра из типа U7 в тип T7. Если не указана, используется
        /// стандартное преобразование типов.</param>
        /// <param name="converter8">Функция преобразования восьмого входного параметра из типа U8 в тип T8. Если не указана, используется
        /// стандартное преобразование типов.</param>
        /// <param name="r2">Функция преобразования результата из типа R1 в тип R2. Если не указана, используется стандартное преобразование
        /// типов.</param>
        ...
        /// <remarks>Если преобразователь для параметра не указан, используется стандартное преобразование типов
        /// через TypeHelper.ChangeType. Это позволяет гибко адаптировать сигнатуру функции к различным типам входных данных
        /// и результата.</remarks>
