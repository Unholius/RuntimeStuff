namespace RuntimeStuff.Extensions
{
    ...
    public static class EnumerableExtensions
    {
        ...
        public static IEnumerable<T> Filter<T>(this IEnumerable<T> source, string filterExpression) where T : class => FilterHelper.Filter(source, filterExpression);

        public static IEnumerable<T> FilterByText<T>(this IEnumerable<T> source, string text) where T : class => FilterHelper.FilterByText(source, text);
        ...
        public static IOrderedEnumerable<T> Sort<T>(this IEnumerable<T> source, ListSortDirection order, params string[] propertyNames) where T : class => SortHelper.Sort(source, order, propertyNames);

        public static IOrderedEnumerable<T> Sort<T>(this IEnumerable<T> source, ListSortDescriptionCollection sortDescription) where T : class => SortHelper.Sort(source, sortDescription);
        ...
        public static DataTable ToDataTable<T>(this IEnumerable<T> source, string tableName = null, params Expression<Func<T, object>>[] columnSelectors) where T : class => DataTableHelper.ToDataTable(source, tableName, columnSelectors);
        ...
        /// <returns>Объект DataTable, содержащий данные из исходной последовательности. Если последовательность пуста,
        /// возвращается таблица только со структурой столбцов.</returns>
        public static DataTable ToDataTable<T>(this IEnumerable<T> source, string tableName, params (Expression<Func<T, object>> propertySelector, string columnName)[] columnSelectors) where T : class => DataTableHelper.ToDataTable(source, tableName, columnSelectors);
