...
public static class DateTimeHelper
{
    ...
    /// <summary>
    /// Parses the specified string and returns its value as a <see cref="DateTime"/> object.
    /// </summary>
    /// <param name="s">The string representation of a date and time to parse. The string must be in a format recognized by the current
    /// culture.</param>
    /// <returns>A <see cref="DateTime"/> value equivalent to the date and time contained in <paramref name="s"/>.</returns>
    public static DateTime ParseDate(string s)
    {
        return TypeHelper.ChangeType<DateTime>(s);
    }
}